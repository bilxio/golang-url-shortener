...
buildDockerImage:
	...
	docker build -t bilxio/golang_url_shortener:arm -f build/Dockerfile.arm .
	docker build -t bilxio/golang_url_shortener -f build/Dockerfile.amd64 .
